...
export function fitCanvas(canvas, ctx) {
	...
	let canvasRatio = scaleCanvas(canvas, ctx, canvas.width, canvas.height);
    ...
    document.querySelector("link[name='css']").href = "mobileStyle.css";
    return {isMobile: true, canvasRatio};
	}
  document.querySelector("link[name='css']").href = "style.css";
  return {isMobile: false, canvasRatio};
}
