...
export function fitCanvas(canvas: HTMLCanvasElement, ctx: Context2D): deviceInfo {
	...
	// Switch stylesheet on mobile
	const styleSheet = <HTMLLinkElement> document.querySelector("link[name='css']")
    ...
    styleSheet.href = 'mobileStyle.css'
    return <deviceInfo> { isMobile: true, canvasRatio }
	}
